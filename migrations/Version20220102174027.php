 ...
 */
final class Version20220102174027 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE livre (id INT AUTO_INCREMENT NOT NULL, isbn VARCHAR(17) NOT NULL, titre VARCHAR(255) NOT NULL, nombre_pages INT NOT NULL, date_de_parution DATETIME NOT NULL, note INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_55AB1409EC4D73F ON auteur (nationalite)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_55AB1409EC4D73F ON auteur');
    }
}
